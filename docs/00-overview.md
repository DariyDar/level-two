...
- Название
- Количество дней
- Список ID доступной еды
- Список ID доступных интервенций
- Требования по углеводам (min/max)
...
- Органы: Liver, BG, Pancreas+Muscles, Kidneys
...
2. В уровне указываются ID еды и интервенций из общих файлов
...
- [ ] Простая сетка слотов (только Morning)
- [ ] 2-3 корабля еды
- [ ] Базовый движок (Liver → BG)
