...
1. **График BG — формат данных**: График показывает **18 точек** (по одной на час) или **интерполированную плавную линию**?

2. **График BG — зоны**: Зоны (low/target/high/critical) — это **заливка фона** разными цветами или только **горизонтальные линии-маркеры**?

3. **Excess BG indicator**: Круги "улетают к органам" — это нужно для прототипа или отложить в polish slice?

4. **Retry из Results**: При нажатии Retry — возвращаемся в Planning того же дня или начинаем весь уровень сначала?
