...
const L1D1: TutorialStep[] = [
  ...
  {
    id: 'L1D1-4',
    bubble: { type: 'dialogue', text: 'When we eat, carbs raise our blood glucose \u2014 the more carbs, the higher the spike. Each food card shows its absorption speed: Fast foods peak quickly, Slow foods rise gradually.', expression: 'happy' },
    blockInteraction: true,
    advanceOn: 'tap',
  },
  {
