...
const L2D1: TutorialStep[] = [
  ...
  },
  {
    ...
    highlightType: 'pulse',
    cta: { type: 'drag-arrow', source: 'intervention:lightwalk', dest: 'slot:11' },
    advanceOn: 'action',
...
const L2D3: TutorialStep[] = [
  {
    ...
    highlightType: 'pulse',
    cta: { type: 'drag-arrow', source: 'intervention:heavyrun', dest: 'slot:10' },
    advanceOn: 'action',
    expectedAction: { type: 'place-intervention', interventionId: 'heavyrun' },
  },
  {
...
const L_STRESS_D1: TutorialStep[] = [
  {
    id: 'T7D1-1',
    bubble: { type: 'dialogue', text: 'Sadly, stress is a common part of daily life \u2014 it affects not just our mood, but our body too.', expression: 'concerned' },
    advanceOn: 'tap',
  },
  {
    id: 'T7D1-2',
    bubble: { type: 'warning', text: 'See the red column? That\'s a stress slot. Insulin is less effective here \u2014 it absorbs 1 glucose cube less.', expression: 'concerned' },
  ...
  {
    id: 'T7D1-3',
    bubble: { type: 'dialogue', text: 'Let\'s place a meal in the stress slot to see how it affects your glucose.', expression: 'neutral', position: 'inventory' },
    highlight: 'stress-slots',
    highlightType: 'pulse',
    noBackdrop: true,
    advanceOn: 'action',
    expectedAction: { type: 'place-food', slotIndex: 12 },
  },
  {
    id: 'T7D1-4',
...
const L_KCAL_D2: TutorialStep[] = [
  {
    id: 'T2D2-1',
    bubble: { type: 'warning', text: 'Overeating raises BG dangerously high and puts excessive strain on the pancreas..', expression: 'concerned', position: 'inventory' },
    highlight: 'kcal-bar',
    highlightType: 'pulse',
    noBackdrop: true,
    advanceOn: 'tap',
  ...
  {
    id: 'T2D2-2',
    bubble: { type: 'dialogue', text: 'Over time, overeating leads to obesity — which harms the whole body and accelerates diabetes progression.', expression: 'concerned', position: 'inventory' },
    noBackdrop: true,
    advanceOn: 'tap',
    blockInteraction: true,
  },
  {
    id: 'T2D2-3',
    bubble: { type: 'dialogue', text: "In our game, it's penalized by increasing the next day's Calorie requirement. Notice the Calorie bar!", expression: 'thinking', position: 'inventory' },
    highlight: 'kcal-bar',
    highlightType: 'pulse',
    noBackdrop: true,
    advanceOn: 'tap',
  ...
  {
    id: 'T2D2-4',
    bubble: { type: 'dialogue', text: "The schedule is cleared — let's replan this day!", expression: 'thinking', position: 'inventory' },
    clearPreplaced: true,
    noBackdrop: true,
    advanceOn: 'tap',
    blockInteraction: true,
