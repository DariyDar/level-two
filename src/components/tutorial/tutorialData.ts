...
const L1D1: TutorialStep[] = [
  ...
  {
    id: 'L1D1-10',
    bubble: { type: 'dialogue', text: 'Low GI foods release glucose slowly, giving the pancreas more time to respond. They\u2019re a safer choice for most situations.', expression: 'neutral', position: 'center' },
    blockInteraction: true,
    advanceOn: 'tap',
  },
  {
